<script lang="ts">
	...
	let currentBalance;
	const transactions = getTransactions([new Date('2023-01-01'), new Date('2023-01-31')]);
</script>
...
<section>
	...
	<ScoreCard label="Forecast" score={currentBalance - (Math.abs($transactions.transactions.reduce((sum, transaction) => sum + transaction.amount, 0)))}></ScoreCard>	
</section>
