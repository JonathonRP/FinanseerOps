				...
				<Motion.div
					...
					<span class="-mr-4 flex items-baseline justify-between">
						<div class="flex flex-col items-start">
							...
							<p class="relative flex flex-row items-center justify-center overflow-hidden py-0.5 text-xs text-muted-foreground">
						...
						<form
							...
							<Motion.button
								class="flex flex-row items-center justify-end justify-items-end text-sm"
								whileHover="hover">
								See all
								<Motion.span
									variants={{
